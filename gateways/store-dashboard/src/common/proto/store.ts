...
export const StoreServiceService = {
  ...
  create: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateStoreInput): Buffer => Buffer.from(CreateStoreInput.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateStoreInput => CreateStoreInput.decode(value),
    responseSerialize: (value: Store): Buffer => Buffer.from(Store.encode(value).finish()),
    responseDeserialize: (value: Buffer): Store => Store.decode(value),
  },
  getById: {
    path: "/store.StoreService/GetById",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StoreById): Buffer => Buffer.from(StoreById.encode(value).finish()),
    requestDeserialize: (value: Buffer): StoreById => StoreById.decode(value),
    responseSerialize: (value: Store): Buffer => Buffer.from(Store.encode(value).finish()),
    responseDeserialize: (value: Buffer): Store => Store.decode(value),
  },
  getByOwner: {
  ...
  getActive: {
    ...
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
    responseSerialize: (value: StoreList): Buffer => Buffer.from(StoreList.encode(value).finish()),
    responseDeserialize: (value: Buffer): StoreList => StoreList.decode(value),
  },
  getInactive: {
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateStoreInput): Buffer => Buffer.from(UpdateStoreInput.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateStoreInput => UpdateStoreInput.decode(value),
    responseSerialize: (value: Store): Buffer => Buffer.from(Store.encode(value).finish()),
    responseDeserialize: (value: Buffer): Store => Store.decode(value),
  },
  activate: {
